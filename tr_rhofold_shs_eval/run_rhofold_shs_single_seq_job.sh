#!/bin/bash
#SBATCH --job-name=rhofold_shs_single_seq
#SBATCH --partition=gpu-single
#SBATCH --output=logs/rhofold_shs_single_seq_%j.out
#SBATCH --error=logs/rhofold_shs_single_seq_%j.err
...
OUT_DIR="${OUT_DIR:-${BASE_DIR}/predictions_rhofold_shs_single_seq}"
...
CMD=(
  ...
  --device cuda
  --skip-existing
  --log-file "logs/rhofold_shs_single_seq_${SLURM_JOB_ID}.log"
)
