#!/bin/bash
#SBATCH --job-name=rhofold_shs_from_rnaformerN100
#SBATCH --partition=gpu-single
#SBATCH --output=logs/rhofold_shs_from_rnaformerN100_%j.out
#SBATCH --error=logs/rhofold_shs_from_rnaformerN100_%j.err
...
OUT_DIR="${OUT_DIR:-${BASE_DIR}/predictions_rhofold_on_shs_from_rnaformerN100_folder}"
...
CMD=(
  ...
  --device cuda
  --skip-existing
  --log-file "logs/rhofold_shs_from_rnaformerN100_${SLURM_JOB_ID}.log"
)
