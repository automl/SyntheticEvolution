#!/bin/bash
#SBATCH --job-name=rhofold_shs_from_spotrna
#SBATCH --partition=gpu-single
#SBATCH --output=logs/rhofold_shs_from_spotrna_%j.out
#SBATCH --error=logs/rhofold_shs_from_spotrna_%j.err
...
CMD=(
  ...
  --device cuda
  --skip-existing
  --log-file "logs/rhofold_shs_from_spotrna_${SLURM_JOB_ID}.log"
)
